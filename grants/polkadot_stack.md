...
| DEXs |[OAX](https://github.com/OAXFoundation?tab=repositories) | privacy-preserving DEX with [dark pool](https://en.wikipedia.org/wiki/Dark_pool)-like properties that obscures identities of trading parties and their order sizes
